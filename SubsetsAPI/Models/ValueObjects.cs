...
public record GuessData(string GuessText, int ReferenceWordIndex, int GuessNumber, int HighlightIndex, bool Hint);
...
public record HintResponse(char TargetCharacter, int CluePosition, string? Message);
